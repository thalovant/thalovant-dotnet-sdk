namespace Thalovant.Sdk.Tests
{
    ...
    {
        /// <summary>OperationResource from app/schemas/operations.py (all 16 fields).</summary>
        internal const string Operation = """
        {
        ...
        /// <summary>Minimal OperationResource where optional fields are null.</summary>
        internal const string OperationPending = """
        {
        ...
        /// <summary>MemoryItemResource from app/schemas/memory.py.</summary>
        internal const string MemoryItem = """
        {
        ...
        /// <summary>MemoryListResponse from app/schemas/memory.py.</summary>
        internal static readonly string MemoryList = $$$"""
        {
          "data": [{{{MemoryItem}}}],
        ...
        /// <summary>MemorySummaryResponse from app/schemas/memory.py.</summary>
        internal const string MemorySummary = """
        {
          "total": 12,
